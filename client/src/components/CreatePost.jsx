  ...
  return (
    <div>
      ...
      <div className="flex  p-4 items-start ">
        ...
        <div className="ml-4 flex-1 ">
          <textarea
            ...
            className="border-b border-amber-200 outline-none w-full  resize-none h-40"
          />
        </div>
      </div>
      ...
      <div className="flex justify-between px-8 items-center">
        ...
        <button className="bg-black text-lg text-white font-semibold py-2 rounded-4xl px-8">Post</button>
      </div>
    </div>
  );
};
